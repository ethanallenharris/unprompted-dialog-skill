...
class UnpromptedDialog(MycroftSkill):
    ...
    def initialize(self): 
        ...
        self.settings['dialogOptions'] = ['unprompted.generic', 'unpromted.didyouknow', 'unprompted.relationship', 'unprompted.selfimprovement', 'unprompted.spiritual', 'unprompted.short']
